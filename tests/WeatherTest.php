...
namespace AttitudeFx\Weather\Tests;

use AttitudeFx\Weather\Exceptions\HttpException;
use AttitudeFx\Weather\Exceptions\InvalidArgumentException;
use AttitudeFx\Weather\Weather;
